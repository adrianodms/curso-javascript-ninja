(function () {
    ...
    */
    console.log('\nJust Numbers:');
    var justNumbers = numberObjects.map(
    ...
    */
    ...
    var nome = ['A', 'dri', 'a', 'no', 'Du', 'tra'];
    var nomeNaLinguaDoP = nome.reduce(function (acumulado, atual) {
        return acumulado + ' P ' + atual;
    },'');
    console.log(nomeNaLinguaDoP);
    ...
    */
    ...
    var existe = numberObjects.lastIndexOf({ number: 2 }, 2) > -1;
    if (existe) {
        console.log('Existe um objeto { number: 2 } em numberObjects!');
    } else {
        console.log('Não existe um objeto { number: 2 } em numberObjects :(')
