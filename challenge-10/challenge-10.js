(function () {
  ...
  */
  ...
  executeOperation(operationSignal, number1, number2, sum);
  ...
  */
  ...
  executeOperation(operationSignal, number1, number2, subtraction);
  executeOperation(operationSignal, number1, number2, multiplication);
  executeOperation(operationSignal, number1, number2, division);
  executeOperation(operationSignal, number1, number2, mod);
  executeOperation(operationSignal, number1, number2, invalid);
