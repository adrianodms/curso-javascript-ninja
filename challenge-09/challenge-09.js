(function () {
    ...
    */
    var response = sum(function (a, b) { return a + b });
    console.log('O resultado da soma é:' + response);
    ...
    */
    var subtraction = calculator(5, 91);
    var multiplication = calculator(5, 92);
    var division = calculator(5, 93);
    var mod = calculator(94,5);
    ...
    chamada.
    */
    var result = subtraction(function (a, b) { return a - b });
    console.log('O resultado da subtração é:' + result);
    // ?
    var result = multiplication(function (a, b) { return a * b });
    console.log('O resultado da multiplicação é:'+ result);
    // ?
    var result = division(function (a, b) { return a / b });
